...
export default function Home() {
  return (
    <main className="h-screen grid grid-rows-2 overflow-x-hidden">
      <section className="grid grid-cols-1 h-screen pt-10 px-5 min-[500px]:px-20 sm:px-40 md:grid-rows-4 md:px-8 md:pt-3">
        <div className="grid md:grid-cols-2 md:grid-rows-1 md:row-start-2 md:row-end-4 md:w-10/12 md:justify-self-center lg:w-9/12 xl:w-8/12">
          <div className={`self-start md:col-start-2 md:col-end-3 md:flex md:justify-end md:mt-10 ${styles.FateInRight}`}>
            <Image
          ...
          <div className={`self-center mx-2 md:col-start-1 md:col-end-2 md:-rotate-12 ${styles.FateInLeft}`}>
